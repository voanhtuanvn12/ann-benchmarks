...
def create_workers_and_execute(definitions: List[Definition], args: argparse.Namespace):
    ...
    try:
        workers = [
            multiprocessing.Process(target=run_worker, args=(i + 1, mem_limit, args, task_queue))
...
def main():
    ...
    # print(f"loaded dataset '{dataset}' with dimension {dimension}")
    ...
    for d in definitions:
        print("definition algorithm:", d.algorithm, d.docker_tag)
